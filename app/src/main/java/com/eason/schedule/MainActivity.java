...
public class MainActivity extends BaseActivity {
    ...
    private void initPopupWindow() {
        ...
        lvPopupList.setAdapter(new SimpleAdapter(MainActivity.this, setList,
                R.layout.list_item_text, new String[] { "share_key" },
                new int[] { R.id.tv_list_item }));
        lvPopupList.setSelection(ScheduleFunc.getInstance()._weekOfToday-2);
        pwMyPopWindow.setBackgroundDrawable(MainActivity.this.getResources().getDrawable(R.drawable.popupwindow));
    ...
    private void initLesson(int week){
        ...
        if(lessonDatas != null){
            for(int i = 0;i < lessonDatas.size();i++){
                ...
                lesson.getLayoutParams().height = Utils.dip2px(MainActivity.this,80*(dt+1));
                ...
                lesson.setOnClickListener(new View.OnClickListener(){
                    ...
                    public void onClick(View view) {
                        ...
                        if(view.getTag().toString().equals("lesson")){
                            ...
                            view.setTag("lesson");
                            id = -1;
                            Intent intent = new Intent(MainActivity.this,WatchLesson.class);
                            ...
                            view.setTag("none");
                            id = -1;
                            Intent intent = new Intent(MainActivity.this,CreateLesson.class);
                            ScheduleFunc.getInstance().lesson.setWeekDay(weekday+"");
                            ScheduleFunc.getInstance().lesson.setFromClass(classnum+"");
    ...
    private void reset(int weeknum){
        ...
        for(int i = 1;i <= 12;i++){
            for(int j = 1;j <= 7;j++){
                ...
                lesson.setBackgroundResource(R.drawable.bg_lesson);
                lesson.getLayoutParams().height = Utils.dip2px(MainActivity.this,80);
                lesson.setText("");
            }
        }
        initLesson(weeknum);
